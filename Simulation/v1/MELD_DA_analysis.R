...
UMAP_output <- read.csv(paste0("RawCountData/UMAP_Raw_",proj,"_v",ver,".csv"))

# Load PCs
PCA_output <- read.csv(paste0("RawCountData/PCA_Raw_",proj,"_v",ver,".csv"))
