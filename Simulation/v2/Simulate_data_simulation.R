...
delta.syn[sum(nbt[1:4]) + (nbt[5]/4+1):(nbt[5]/2)] <- -0.5
delta.syn[sum(nbt[1:4]) + (nbt[5]/2+1):nbt[5]] <- -1

# the sixth pair
delta.syn[sum(nbt[1:5]) + 1:(nbt[6]/4)] <- 0
delta.syn[sum(nbt[1:5]) + (nbt[6]/4+1):(nbt[6]/2)] <- 1
delta.syn[sum(nbt[1:5]) + (nbt[6]/2+1):nbt[6]] <- 0.5

# the seventh pair
delta.syn[sum(nbt[1:6]) + 1:(nbt[7]/2)] <- 0
delta.syn[sum(nbt[1:6]) + (nbt[7]/2+1):nbt[7]] <- 2

# the eighth pair
delta.syn[sum(nbt[1:7]) + 1:(nbt[8]/4)] <- 0
delta.syn[sum(nbt[1:7]) + (nbt[8]/4+1):(nbt[8]/2)] <- 0.5
delta.syn[sum(nbt[1:7]) + (nbt[8]/2+1):nbt[8]] <- 0.8
